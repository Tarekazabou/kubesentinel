...
const featureDemos = {
  ...
  ai: {
    ...
    lines: [
      { text: 'curl -s http://localhost:5000/health | python3 -m json.tool', cls: 't-cyan' },
      { text: '{', instant: true, noPrompt: true, pause: 100 },
      ...
      { text: 'curl -s -X POST http://localhost:5000/analyze -d \'{"event": "shell_spawn"}\' | python3 -m json.tool', cls: 't-cyan' },
      { text: '{', instant: true, noPrompt: true, pause: 100 },
